...
class MakeDone(BaseCommand):
    ...
    def perform(self, objects, *args, **kwargs):
        ...
        while True:
            try:
                selection = int(get_input_function()('Input number: '))
                selection_record = objects[selection]
                if not selection_record.done:
                    selection_record.done = True
                else: 
                    print('This deal have been done!!!')
                    break
                print('{} is done!'.format(str(selection_record)))
    ...
    def perform(self, objects, *args, **kwargs):
        ...
        while True:
            try:
                selection = int(get_input_function()('Input number: '))
                selection_record = objects[selection]
                if selection_record.done:
                    selection_record.done = False
                else: 
                    print('This deal is undone!!!')
                    break
                print('{} is done!'.format(str(selection_record)))
